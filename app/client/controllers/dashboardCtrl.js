...
var dashboardCtrl = function($scope, $location, dataService){
	...
	var getUserIdentite = function() {
		...
		$scope.dashboards.push({id:'identite', label:'Identité', dash:identite, show:true, row:2, icone:'profile.svg'});
	}
	var getUserBanque = function() {
		var dashboard = {id:'banque', label:'Coordonnées Bancaires', dash:{}, loading:true, show:true, row:1, icone:'credit.svg'};
	...
	var getUserFai = function() {
		var dashboard = {id:'fai', label:'FAI', dash:{}, loading:true, show:true, row:1, icone:'fai.svg'}
		$scope.dashboards.push(dashboard);
	...
	var getUserCasier = function() {
		var dashboard = {id:'casier', label:'Casier Judiciaire', dash:{}, loading:true, show:true, row:1, icone:'casier.svg'}
		$scope.dashboards.push(dashboard);
	...
	var getUserAcossSituationPro = function() {
		var dashboard = {id:'situPro', label:'Situation professionnelle', dash:{}, loading:true, show:true, row:2, icone:'travail.svg'}
		$scope.dashboards.push(dashboard);
